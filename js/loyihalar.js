        ...
        try {
            ...
            projects.forEach(project => {
                ...
                projectCard.innerHTML = `
                    <h3 class="project-title" data-id="${project.id}">
                        ${project.name || 'N/A'} <span class="task-hint" style="font-size: 0.8em; color: #777;">- Vazifalar bu yerda</span>
                    </h3>
            ...
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", async (event) => {
                    ...
                    if (!currentProjectId) {
                        console.error("currentProjectId aniqlanmadi");
                    ...
                    try {
                        ...
                        document.getElementById("edit-statusMasul").value = project.responsible || (project.responsible ? project.responsible : 'J.Xafizov');
